...
@Autonomous(name = "Albastru2ss")
@Disabled
public class Albastru2ss extends LinearOpMode {
...
//        robot.rotate(85, 1, 3);//
    ...
    void noSkystone() {
        ...
        robot.strafe(680, 0.65, 3);//1000
        double correction = robot.maintainAngle();
        robot.rotateEncoders(robot.conversieDegreesToTicks(correction + 4), 1, 2);
        ...
        robot.runUsingEncoders(2850, 0.7, 4);//3150
        ...
        robot.ridicareBratDreapta.setPower(0);
        robot.rotateEncoders(-robot.conversieDegreesToTicks(84), 1, 1);
        robot.runUsingEncoders(1775, 0.7, 4);
        robot.ridicareBratDreapta.setPower(0.8);
        robot.rotateEncoders(robot.conversieDegreesToTicks(90), 1, 1);
        robot.ridicareBratDreapta.setPower(0);

        robot.runUsingEncoders(500, 0.6, 2);
