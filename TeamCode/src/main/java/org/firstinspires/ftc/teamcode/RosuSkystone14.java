...
@Autonomous(name = "Rosu SKYSTONE 1-4")
@Disabled
public class RosuSkystone14 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            robot.rotateEncoders(robot.conversieDegreesToTicks(35), 0.5, 2);
            ...
            robot.rotateEncoders(-robot.conversieDegreesToTicks(120), 0.8, 2);
            ...
            robot.runUsingEncoders(robot.conversieCmToTick(460), 0.5, 4);//500
            ...
            robot.runUsingEncoders(-robot.conversieCmToTick(2220), 1, 3);
