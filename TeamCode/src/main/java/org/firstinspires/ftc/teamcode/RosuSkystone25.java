...
@Autonomous(name = "Rosu SKYSTONE 2-5")
@Disabled
public class RosuSkystone25 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            robot.rotateEncoders(robot.conversieDegreesToTicks(25), 0.5, 2);

            robot.runUsingEncoders(robot.conversieCmToTick(1125), 0.3, 4);
            ...
            robot.rotateEncoders(-robot.conversieDegreesToTicks(110), 0.8, 2);


            //Mers la perete
            robot.runUsingEncoders(robot.conversieCmToTick(2550), 1, 9);
            while (robot.senzorDistanta.getDistance(DistanceUnit.MM) >= 380) {
                robot.forward(0.4);
            }
            robot.rotateEncoders(robot.conversieDegreesToTicks(91), 1, 2);
            ...
            robot.runUsingEncoders(-robot.conversieCmToTick(1980), 1, 3);
            ...
            robot.runUsingEncoders(robot.conversieCmToTick(2000), 1, 2);
            robot.ghearaStanga.setPosition(0.5);
